  ...
  const getRegionIcon = (region: Server | 'any') => {
    switch (region) {
      case 'any':
        ...
        case 'TR1':
            return (
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64"><path fill="#e30a17" d="M61.333 32C61.333 48.2 48.2 61.333 32 61.333S2.667 48.2 2.667 32 15.8 2.667 32 2.667 61.333 15.8 61.333 32z"></path><path fill="#fff" d="M42.092 32.055c0 6.764-5.546 12.247-12.388 12.247s-12.388-5.483-12.388-12.247 5.546-12.247 12.388-12.247 12.388 5.483 12.388 12.247z"></path><path fill="#e30a17" d="M42.711 32.055c0 5.411-4.437 9.797-9.911 9.797s-9.911-4.386-9.911-9.797c0-5.411 4.437-9.797 9.911-9.797s9.911 4.386 9.911 9.797z"></path><path fill="#fff" d="m39.511 32.055 11.205 3.6-6.925-9.424v11.648l6.925-9.424z"></path></svg>
            )

        case 'PH2':
            return (
                <svg viewBox="0 0 48 48"><path fill="#0038A8" fill-rule="evenodd" d="M45.954 25.429H3.214v-8.655C6.204 8.174 14.381 2 24 2c12.15 0 22 9.85 22 22 0 .48-.015.956-.046 1.429Z" clip-rule="evenodd"></path><path fill="#CE1126" fill-rule="evenodd" d="M46 24c0 12.15-9.85 22-22 22S2 36.15 2 24h44Z" clip-rule="evenodd"></path><path fill="#fff" fill-rule="evenodd" d="M6.028 36.714 28.342 24 6.085 11.25A21.9 21.9 0 0 0 2 24.02a21.9 21.9 0 0 0 4.028 12.693Z" clip-rule="evenodd"></path><path fill="#FCD116" d="m11.769 17.755-.38.38.188 2.879a2.91 2.91 0 0 0-.19.019l-.346-2.627-.31.31.466 2.348a2.91 2.91 0 0 0-1.055.437l-1.33-1.99h-.438l1.613 2.102c-.051.039-.1.08-.148.122l-1.903-2.17H7.4v.538l2.17 1.902a2.94 2.94 0 0 0-.122.149L7.344 20.54v.439l1.991 1.33a2.91 2.91 0 0 0-.438 1.055l-2.348-.467-.31.31 2.627.346a2.928 2.928 0 0 0-.018.19l-2.88-.188-.38.38.38.38 2.88-.188c.004.064.01.128.018.19l-2.627.346.31.31 2.348-.466c.076.384.227.74.438 1.055l-1.99 1.33v.438l2.102-1.613c.039.051.08.1.121.148l-2.17 1.903v.537h.538l1.903-2.17c.048.043.097.083.148.122L8.374 28.36h.438l1.33-1.991c.315.21.671.362 1.056.438l-.468 2.348.31.31.347-2.627c.063.008.126.014.19.018l-.188 2.88.38.38.38-.38-.189-2.88c.064-.004.128-.01.19-.018l.347 2.627.31-.31-.467-2.348a2.91 2.91 0 0 0 1.055-.438l1.33 1.99h.439l-1.613-2.102c.05-.039.1-.08.147-.121l1.903 2.17h.538v-.538l-2.17-1.903c.042-.048.083-.097.122-.148l2.102 1.613v-.438l-1.99-1.33a2.92 2.92 0 0 0 .437-1.056l2.348.468.31-.31-2.627-.347a2.91 2.91 0 0 0 .019-.19l2.879.188.38-.38-.38-.38-2.879.189a2.907 2.907 0 0 0-.019-.19l2.627-.347-.31-.31-2.348.467a2.91 2.91 0 0 0-.437-1.055l1.99-1.33v-.439l-2.102 1.613a2.96 2.96 0 0 0-.122-.147l2.17-1.903v-.538H15.6l-1.903 2.17a2.924 2.924 0 0 0-.148-.122l1.614-2.102h-.439l-1.33 1.99a2.91 2.91 0 0 0-1.055-.437l.467-2.348-.31-.31-.346 2.627a2.917 2.917 0 0 0-.19-.019l.188-2.879-.38-.38Z"></path></svg>            )
      case 'LA1':
        return (
      ...
      case 'LA2':
        return (
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
            <path fill="var(--svg-bg, var(--shade9, black))" d="M61.333 32C61.333 48.2 48.2 61.333 32 61.333S2.667 48.2 2.667 32 15.8 2.667 32 2.667 61.333 15.8 61.333 32z"></path>
            <path fill="var(--svg-fg, var(--shade0, white))" d="M32 54c0-.299-1.798-1.911-5.394-4.837l-1.68-14.117 1.68-3.698-.602-13.651.602-3.512v-3.123l2.356-.57.999 1.564 4.052 3.193 1.545 5.268 3.593 3.061-1.837 3.576 2.546 3.726L36.468 32l.846 3.046-4.195 2.006-1.121 4.434-.903 2.949.903 2.247-1.51 2.482 3.525 4.205c-1.343.72-2.014.93-2.014.631z"></path>
          </svg>
        );
      case 'VN2':
        return (
