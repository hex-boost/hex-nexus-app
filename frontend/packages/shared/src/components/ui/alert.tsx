...
const Alert = (
  { ref, className, variant, size, isNotification, icon, action, layout = 'row', children, ...props }: AlertProps & { ref?: React.RefObject<HTMLDivElement | null> },
) => (
  <div
    ref={ref}
    role="alert"
...
const AlertContent = ({ ref, className, ...props }: React.HTMLAttributes<HTMLDivElement> & { ref?: React.RefObject<HTMLDivElement | null> }) => (
