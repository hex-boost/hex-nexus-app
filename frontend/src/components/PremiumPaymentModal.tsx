...
type PremiumPaymentModalProps = {
  ...
  onClose: () => void;
  tier: string;
  paymentMethod: 'Pix' | 'Stripe' | 'BR Balance';
  amount?: number;
  colorKey: 'blue' | 'primary' | 'purple' | 'emerald';
};
  ...
  const paymentIcons = {
    ...
    'BR Balance': (
      <svg height="32" width="32" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 39 39">
        <g clipPath="url(#logo-icon_svg__a)">
          <circle cx="19.797" cy="19.02" r="13.586" fill="#0F061E"></circle>
          <path
            fill="currentColor"
            d="M19.408 0a19.408 19.408 0 1 0 0 38.817 19.408 19.408 0 0 0 0-38.817M8.757 26.652l-.45-11.816 5.667 4.89 7.965 6.926zm15.527 0-9.534-8.268 4.658-7.71 9.673 15.978zm5.845-1.227-4.285-7.127 4.658-3.462z"
          >
          </path>
        </g>
        <defs>
          <clipPath id="logo-icon_svg__a">
            <path fill="#fff" d="M0 0h38.817v38.817H0z"></path>
          </clipPath>
        </defs>
      </svg>
    ),
