...
export function LoginForm({
  ...
  return (
    <div className={cn("flex justify-center items-center w-[1280px] h-[720px] flex-col gap-6", className)} {...props}>
      <Card className="border-none overflow-hidden w-full h-full">
        <CardContent className="grid  w-full h-full p-0 md:grid-cols-2">
          ...
          >
            <form onSubmit={handleSubmit} className="flex flex-col gap-6 justify-center max-w-[480px]  w-full items-center ">
              ...
              <Button type="button" onClick={handleDiscordLogin} variant="outline" className="w-full space-x-2">
                <DiscordSvg />
