...
export interface ApiInvalidAccountInvalidAccount
  extends Struct.SingleTypeSchema {
  collectionName: 'invalid_accounts';
  info: {
    description: '';
    displayName: 'Invalid account';
    pluralName: 'invalid-accounts';
    singularName: 'invalid-account';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::invalid-account.invalid-account'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/types' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::invalid-account.invalid-account': ApiInvalidAccountInvalidAccount;
