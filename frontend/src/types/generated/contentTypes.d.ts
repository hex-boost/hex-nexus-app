...
export interface ApiAccountAccount extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    actionHistory: Schema.Attribute.Relation<'oneToMany', 'api::action.action'>;
    bannedGames: Schema.Attribute.Enumeration<['league', 'valorant']>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    gamename: Schema.Attribute.String;
    isRented: Schema.Attribute.Boolean;
    LCUchampions: Schema.Attribute.JSON;
    LCUskins: Schema.Attribute.JSON;
    leaverBuster: Schema.Attribute.Enumeration<['level1', 'level2']>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::account.account'
    ...
    server: Schema.Attribute.Enumeration<['NA', 'EUW', 'EUNE', 'OCE', 'BR']>;
...
export interface ApiPremiumPremium extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    tier: Schema.Attribute.Enumeration<['tier 1', 'tier 2', 'tier 3']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    user: Schema.Attribute.Relation<
